        ...
        <div class="item_img">
            ...
            <?php
                ...
                foreach($images as $image){
                    $str = $image;
                    $menuname = mb_substr($str, 6, -4); 
                    /* $imageの文字数を先頭から6文字（パスの　image/　不要な部分）、
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="Label_toriseiniku"><?php print($menuname);?>　2本：<?php print($menu_price.'円');?></h4>
                            </div>
