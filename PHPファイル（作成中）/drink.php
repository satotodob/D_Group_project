...
<div class="item">
    <h2>オレンジジュース</h2>
    オレンジジュース　205円<br>
    <button type="button" data-toggle="modal" data-target="#orange" data-backdrop="static"></button>
</div>

<div class="item">
    <h2>ウーロン茶</h2>
    ウーロン茶　205円<br>
    <button type="button" data-toggle="modal" data-target="#oolong" data-backdrop="static"></button>
</div>

<div class="item">
    <h2>カルピス</h2>
    カルピス　225円<br>
    <button type="button" data-toggle="modal" data-target="#calp" data-backdrop="static"></button>
</div>

<div class="item">
    <h2>コーラ</h2>
    コーラ　205円<br>
    <button type="button" data-toggle="modal" data-target="#cola" data-backdrop="static"></button>
</div>
    ...
    <div class="modal fade" id="orange" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="Label_orange">オレンジジュース　205円</h4></h4>
                </div>
                <div class="modal-body">
                    オレンジジュースを注文する
                    <input type="hidden" name="order_item" value=5>
                    <div>
    ...
    <!-- ボタンクリック後に表示される画面の内容 -->
    <form method="post" action="">
    <div class="modal fade" id="oolong" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="Label_oolong">ウーロン茶　205円</h4></h4>
                </div>
                <div class="modal-body">
                    ウーロン茶を注文する
                    <input type="hidden" name="order_item" value=6>
                    <div>
                    <input type="radio" name="item_qty" value=1 checked> 1
                    <input type="radio" name="item_qty" value=2> 2
                    <input type="radio" name="item_qty" value=3> 3
    ...
    <!-- ボタンクリック後に表示される画面の内容 -->
    <form method="post" action="">
    <div class="modal fade" id="calp" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="Label_calp">カルピス　225円</h4></h4>
                </div>
                <div class="modal-body">
                    カルピスを注文する
                    <input type="hidden" name="order_item" value=7>
                    <div>
                    <input type="radio" name="item_qty" value=1 checked> 1
                    <input type="radio" name="item_qty" value=2> 2
                    <input type="radio" name="item_qty" value=3> 3
    ...
    <!-- ボタンクリック後に表示される画面の内容 -->
    <form method="post" action="">
    <div class="modal fade" id="cola" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="Label_cola">コーラ　205円</h4></h4>
                </div>
                <div class="modal-body">
                    コーラを注文する
                    <input type="hidden" name="order_item" value=8>
                    <div>
                    <input type="radio" name="item_qty" value=1 checked> 1
                    <input type="radio" name="item_qty" value=2> 2
                    <input type="radio" name="item_qty" value=3> 3
