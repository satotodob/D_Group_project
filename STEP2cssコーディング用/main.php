...
<html>
    <head>
        ...
        <style>
            ...
            .container-area .object_btn {/*div要素全体をボタンにする設定*/
                position: absolute;
                top: 0;
                left: 0;
                height: 100%;
        ...
        <h1 name="object">串物</h1>
            ...
            <div class="container-area"><!-- メイン画面 -->
                <div class="object_img"><!-- 画像選択 -->
                    <?php
                        $num = 0;
                        $images = glob('mainimg/'.'{*.jpg}',GLOB_BRACE);
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="label1"><?php print $menuname; ?>　2本 <?php print $m_price.'円'; ?></h5>
