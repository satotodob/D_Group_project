...
<div class="item">
    <h2>大根サラダ</h2>
    大根サラダ　330円<br>
    <button type="button" data-toggle="modal" data-target="#daikon" data-backdrop="static"></button>
</div>

<div class="item">
    <h2>冷奴</h2>
    冷奴　195円<br>
    <button type="button" data-toggle="modal" data-target="#hiyaya" data-backdrop="static"></button>
</div>

<div class="item">
    <h2>十勝産枝豆</h2>
    十勝産枝豆　280円<br>
    <button type="button" data-toggle="modal" data-target="#edamame" data-backdrop="static"></button>
</div>
...
<div class="item">
    ...
    豚角煮釜めし　635円<br>
    ※お時間がかかります。
    <button type="button" data-toggle="modal" data-target="#kakuni" data-backdrop="static"></button>
</div>
    ...
    <div class="modal fade" id="daikon" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="Label_daikon">大根サラダ　330円</h4></h4>
                </div>
                <div class="modal-body">
                    大根サラダを注文する
                    <input type="hidden" name="order_item" value=9>
                    <div>
    ...
    <!-- ボタンクリック後に表示される画面の内容 -->
    <form method="post" action="">
    <div class="modal fade" id="hiyaya" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="Label_hiyaya">冷奴　195円</h4></h4>
                </div>
                <div class="modal-body">
                    冷奴を注文する
                    <input type="hidden" name="order_item" value=10>
                    <div>
                    <input type="radio" name="item_qty" value=1 checked> 1
                    <input type="radio" name="item_qty" value=2> 2
                    <input type="radio" name="item_qty" value=3> 3
    ...
    <!-- ボタンクリック後に表示される画面の内容 -->
    <form method="post" action="">
    <div class="modal fade" id="edamame" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="Label_edamame">十勝産枝豆　280円</h4></h4>
                </div>
                <div class="modal-body">
                    十勝産枝豆を注文する
                    <input type="hidden" name="order_item" value=11>
                    <div>
                    <input type="radio" name="item_qty" value=1 checked> 1
                    <input type="radio" name="item_qty" value=2> 2
                    <input type="radio" name="item_qty" value=3> 3
    ...
    <!-- ボタンクリック後に表示される画面の内容 -->
    <form method="post" action="">
    <div class="modal fade" id="kakuni" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="Label_kakuni">豚角煮釜めし　635円</h4></h4>
                </div>
                <div class="modal-body">
                    豚角煮釜めしを注文する
                    <input type="hidden" name="order_item" value=12>
                    <div>
                    <input type="radio" name="item_qty" value=1 checked> 1
                    <input type="radio" name="item_qty" value=2> 2
                    <input type="radio" name="item_qty" value=3> 3
